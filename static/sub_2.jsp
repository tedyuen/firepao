...
<%
    ...
    String tourl = CommonProperties.get("domain")+"/firepao/static/sub_2.jsp?name="+URLEncoder.encode(name,"utf-8")+"&flag="+flag+"&type="+type+"&headurl="+URLEncoder.encode(headurl, "utf-8");
    System.out.println(tourl);
    String url = CommonProperties.get("domain")+"/firepao/static/tosub_2.jsp?name="+URLEncoder.encode(name,"utf-8")+"&flag=&type="+type+"&headurl="+URLEncoder.encode(headurl, "utf-8");
...
<div id="container">
    <div id="index" class="index">
        ...
        <% if("1".equals(type)){%>
            <div class="background-down-22"></div>
            <div class="background-top-22"></div>
        <%}else if("2".equals(type)){%>
            <div class="background-down-23"></div>
            <div class="background-top-23"></div>
        <%}else if("3".equals(type)){%>
            <div class="background-down-24"></div>
            <div class="background-top-24"></div>
        <%}else if("4".equals(type)){%>
            <div class="background-down-25"></div>
            <div class="background-top-25"></div>
        <%}%>
        <img class="sub-2-text-img" src="<%=headurl%>" width="30px"/>
        <div class="sub-2-text text-color2 font20"><%=name%></div>
        <%if("1".equals(flag)){%>
        <div class="share-div">
        ...
        <%}else{%>
        <div class="enter-div">
            <img src="images/icon_enter_btn.png" height="22px">
        </div>
        <%}%>
    </div>
</div>
